...
\begin{figure}[htbp]
    ...
    \fbox{\includegraphics[width=\linewidth]{./figure/trajSystem.pdf}}
    \caption{進行図の提示}
...
\begin{figure}[htbp]
    ...
    \setlength{\fboxsep}{1pt} % フレームの余白を調整
    \setlength{\fboxrule}{1pt} % フレームの太さを調整
    \fbox{\includegraphics[width=\linewidth]{./figure/traj-button.png}}
...
\begin{figure}[htbp]
    ...
    \setlength{\fboxsep}{1pt} % フレームの余白を調整
    \setlength{\fboxrule}{1pt} % フレームの太さを調整
    \fbox{\includegraphics[width=\linewidth]{./figure/best-worst.png}}
...
\begin{table}[H]
    ...
    \resizebox{\linewidth}{!}{
        \begin{tabular}{c|l||c|c}
            ...
            & システムにより振り返りが楽しくなったと感じますか& \bf{4.10} & 4.00  \\
        \end{tabular}
    }
...
\begin{table}[H]
    ...
    \resizebox{\linewidth}{!}{
        \begin{tabular}{c|l||c|c}
            \multicolumn{2}{c}{質問} & \multicolumn{2}{c}{主観評価} \\ \hline \hline
            質問の種類 & 質問の内容 & B(比較手法) & A(提案手法)\\ \hline 
            (a) & 振り返りによって成長したと感じましたか& \bf{3.82} & 3.55  \\
            & 振り返りによってAIの意図を掴むことができたと感じますか & 3.00  & 3.00\\ \hline
            (b) & 今後も connect4 をプレイするときにこのシステムを使いたいと思いましたか& \bf{4.36} & 4.09  \\
            & システムにより振り返りが楽しくなったと感じますか& \bf{4.27} & 3.82  \\
        \end{tabular}
    }
