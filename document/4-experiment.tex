...
group prediction rate， stone prediction rateの計算において，盤面の座標は図\ref{fig:index}のように定められる．
\begin{figure}[htbp]
	\centering
...
\subsection{比較手法}
提案手法に対する比較手法は第2章の「contrastive explanation」の段で述べた「最も有力な」「単一の」予想図を用いた手法である．
...
\begin{figure}[htbp]
    ...
    \fbox{\includegraphics[width=\linewidth]{./figure/basicSystem.png}}
    \caption{開始画面}
    \label{fig:basic}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \setlength{\fboxsep}{1pt} % フレームの余白を調整
    \setlength{\fboxrule}{1pt} % フレームの太さを調整
    \fbox{\includegraphics[width=\linewidth]{./figure/lookBack.png}}
	\caption{振り返り画面}
	\label{fig:lookBack}
\end{figure}
...
\begin{table}[H]
    ...
    \resizebox{\linewidth}{!}{
        \begin{tabular}{c|l||c|c}
            ...
            & (2回目のみ) 1回目に比べて成長したと感じますか & \bf{3.50} & 3.00 \\ \hline
            (b) & 今後も connect4 をプレイするときにこのシステムを使いたいと思いましたか& \bf{4.67} & 4.17  \\
            & システムにより振り返りが楽しくなったと感じますか & \bf{4.67} & 3.33 \\
        \end{tabular}
    }
...
\begin{table}[H]
    ...
    \resizebox{\linewidth}{!}{
        \begin{tabular}{c|l||c|c}
            ...
            & (2回目のみ) 1回目に比べて成長したと感じますか& 3.5  & \bf{4.5}\\ \hline
